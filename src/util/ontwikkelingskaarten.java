...
public class ontwikkelingskaarten {
	...
	Ontwikkelingskaart kaart_1 = new Ontwikkelingskaart(1, Edelsteen.ONYXEN, 1, prijsVanKaart_1);
	
	Edelsteen[] prijsVanKaart_2 = {Edelsteen.DIAMANTEN, Edelsteen.SMARAGDEN, Edelsteen.ROBIJNEN, Edelsteen.ROBIJNEN, Edelsteen.ONYXEN};
	Ontwikkelingskaart kaart_2 = new Ontwikkelingskaart(1, Edelsteen.SAFFIEREN, 0, prijsVanKaart_2);
	
	Edelsteen[] prijsVanKaart_3 = {Edelsteen.DIAMANTEN, Edelsteen.ONYXEN, Edelsteen.ONYXEN};
	Ontwikkelingskaart kaart_3 = new Ontwikkelingskaart(1, Edelsteen.SAFFIEREN, 0, prijsVanKaart_3);
	
	Edelsteen[] prijsVanKaart_4 = {Edelsteen.SMARAGDEN, Edelsteen.ROBIJNEN, Edelsteen.ROBIJNEN, Edelsteen.ROBIJNEN, Edelsteen.ONYXEN};
	Ontwikkelingskaart kaart_4 = new Ontwikkelingskaart(1, Edelsteen.ONYXEN, 0, prijsVanKaart_4);
	
	Edelsteen[] prijsVanKaart_5 = {Edelsteen.DIAMANTEN, Edelsteen.DIAMANTEN, Edelsteen.DIAMANTEN};
	Ontwikkelingskaart kaart_5 = new Ontwikkelingskaart(1, Edelsteen.ROBIJNEN, 0, prijsVanKaart_5);
	...
	Ontwikkelingskaart kaart_41 = new Ontwikkelingskaart(2, Edelsteen.ONYXEN, 2, prijsVanKaart_41);
	...
	Ontwikkelingskaart kaart_42 = new Ontwikkelingskaart(2, Edelsteen.ONYXEN, 1, prijsVanKaart_42);
	...
	Ontwikkelingskaart kaart_43 = new Ontwikkelingskaart(2, Edelsteen.ROBIJNEN, 1, prijsVanKaart_43);
	...
	Ontwikkelingskaart kaart_44 = new Ontwikkelingskaart(2, Edelsteen.SMARAGDEN, 1, prijsVanKaart_44);
	...
	Ontwikkelingskaart kaart_45 = new Ontwikkelingskaart(2, Edelsteen.DIAMANTEN, 2, prijsVanKaart_45);
	...
	Ontwikkelingskaart kaart_71 = new Ontwikkelingskaart(3, Edelsteen.ROBIJNEN, 4, prijsVanKaart_71);
	...
	Ontwikkelingskaart kaart_72 = new Ontwikkelingskaart(3, Edelsteen.ONYXEN, 5, prijsVanKaart_72);
	...
	Ontwikkelingskaart kaart_73 = new Ontwikkelingskaart(3, Edelsteen.ONYXEN, 4, prijsVanKaart_73);
	...
	Ontwikkelingskaart kaart_74 = new Ontwikkelingskaart(3, Edelsteen.SMARAGDEN, 4, prijsVanKaart_74);
	...
	Ontwikkelingskaart kaart_75 = new Ontwikkelingskaart(3, Edelsteen.DIAMANTEN, 5, prijsVanKaart_75);

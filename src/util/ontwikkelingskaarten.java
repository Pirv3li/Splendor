...
private ArrayList<Ontwikkelingskaart> niveau3 = new ArrayList<>();
	...
	niveau1.add(new Ontwikkelingskaart(Edelsteen.ONYXEN, 0, prijsVanKaart_16, 16));
	...
	niveau1.add(new Ontwikkelingskaart(Edelsteen.SMARAGDEN, 0, prijsVanKaart_17, 17));
	...
	niveau1.add(new Ontwikkelingskaart(Edelsteen.DIAMANTEN, 0, prijsVanKaart_18, 18));
	...
	niveau1.add(new Ontwikkelingskaart(Edelsteen.DIAMANTEN, 0, prijsVanKaart_19, 19));
	
	Edelsteen[] prijsVanKaart_20 = {Edelsteen.SAFFIEREN, Edelsteen.SAFFIEREN, Edelsteen.SAFFIEREN};
	niveau1.add(new Ontwikkelingskaart(Edelsteen.DIAMANTEN, 0, prijsVanKaart_20, 20));
	
	
	Edelsteen[] prijsVanKaart_21 = {Edelsteen.DIAMANTEN, Edelsteen.SAFFIEREN, Edelsteen.SMARAGDEN, Edelsteen.ONYXEN};
	niveau1.add(new Ontwikkelingskaart(Edelsteen.ONYXEN, 0, prijsVanKaart_21, 21));
	...
	niveau1.add(new Ontwikkelingskaart(Edelsteen.DIAMANTEN, 0, prijsVanKaart_22, 22));
	
	Edelsteen[] prijsVanKaart_23 = {Edelsteen.SMARAGDEN, Edelsteen.SMARAGDEN, Edelsteen.ROBIJNEN};
	niveau1.add(new Ontwikkelingskaart(Edelsteen.ONYXEN, 0, prijsVanKaart_23, 23));
	
	Edelsteen[] prijsVanKaart_24 = {Edelsteen.SAFFIEREN, Edelsteen.ROBIJNEN, Edelsteen.ROBIJNEN, Edelsteen.ONYXEN, Edelsteen.ONYXEN};
	niveau1.add(new Ontwikkelingskaart(Edelsteen.SMARAGDEN, 0, prijsVanKaart_24, 24));
	
	Edelsteen[] prijsVanKaart_25 = {Edelsteen.ONYXEN, Edelsteen.ONYXEN, Edelsteen.ONYXEN};
	niveau1.add(new Ontwikkelingskaart(Edelsteen.SAFFIEREN, 0, prijsVanKaart_25, 25));
	...
	niveau1.add(new Ontwikkelingskaart(Edelsteen.ROBIJNEN, 0, prijsVanKaart_26, 26));
	
	Edelsteen[] prijsVanKaart_27 = {Edelsteen.DIAMANTEN, Edelsteen.SAFFIEREN, Edelsteen.ROBIJNEN, Edelsteen.ONYXEN, Edelsteen.ONYXEN};
	niveau1.add(new Ontwikkelingskaart(Edelsteen.SMARAGDEN, 0, prijsVanKaart_27, 27));
	
	Edelsteen[] prijsVanKaart_28 = {Edelsteen.ROBIJNEN, Edelsteen.ROBIJNEN, Edelsteen.ONYXEN};
	niveau1.add(new Ontwikkelingskaart(Edelsteen.DIAMANTEN, 0, prijsVanKaart_28, 28));
	...
	niveau1.add(new Ontwikkelingskaart(Edelsteen.SAFFIEREN, 0, prijsVanKaart_29, 29));
	...
	niveau1.add(new Ontwikkelingskaart(Edelsteen.ONYXEN, 0, prijsVanKaart_40, 40));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.DIAMANTEN, 1, prijsVanKaart_46, 46));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.SMARAGDEN, 1, prijsVanKaart_47, 47));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.SAFFIEREN, 2, prijsVanKaart_48, 48));
	
	Edelsteen[] prijsVanKaart_49 = {Edelsteen.ONYXEN, Edelsteen.ONYXEN, Edelsteen.ONYXEN, Edelsteen.ONYXEN, Edelsteen.ONYXEN};
	niveau2.add(new Ontwikkelingskaart(Edelsteen.ROBIJNEN, 2, prijsVanKaart_49, 49));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.ROBIJNEN, 2, prijsVanKaart_50, 50));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.SAFFIEREN, 1, prijsVanKaart_51, 51));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.ROBIJNEN, 1, prijsVanKaart_52, 52));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.SMARAGDEN, 3, prijsVanKaart_53, 53));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.ROBIJNEN, 2, prijsVanKaart_54, 54));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.SAFFIEREN, 2, prijsVanKaart_55, 55));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.SMARAGDEN, 2, prijsVanKaart_56, 56));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.SMARAGDEN, 2, prijsVanKaart_57, 57));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.DIAMANTEN, 2, prijsVanKaart_58, 58));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.DIAMANTEN, 3, prijsVanKaart_59, 59));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.ONYXEN, 2, prijsVanKaart_60, 60));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.SAFFIEREN, 3, prijsVanKaart_61, 61));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.ONYXEN, 2, prijsVanKaart_62, 62));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.DIAMANTEN, 1, prijsVanKaart_63, 63));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.SAFFIEREN, 1, prijsVanKaart_64, 64));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.ONYXEN, 1, prijsVanKaart_65, 65));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.SMARAGDEN, 2, prijsVanKaart_66, 66));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.DIAMANTEN, 2, prijsVanKaart_67, 67));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.ROBIJNEN, 3, prijsVanKaart_68, 68));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.SAFFIEREN, 2, prijsVanKaart_69, 69));
	...
	niveau2.add(new Ontwikkelingskaart(Edelsteen.ROBIJNEN, 3, prijsVanKaart_70, 70));
	...
	niveau3.add(new Ontwikkelingskaart(Edelsteen.DIAMANTEN, 3, prijsVanKaart_76, 76));
	...
	niveau3.add(new Ontwikkelingskaart(Edelsteen.ROBIJNEN, 5, prijsVanKaart_77, 77));
	...
	niveau3.add(new Ontwikkelingskaart(Edelsteen.SAFFIEREN, 3, prijsVanKaart_78, 78));
	...
	niveau3.add(new Ontwikkelingskaart(Edelsteen.SMARAGDEN, 3, prijsVanKaart_79, 79));
	...
	niveau3.add(new Ontwikkelingskaart(Edelsteen.ROBIJNEN, 4, prijsVanKaart_80, 80));
	...
	niveau3.add(new Ontwikkelingskaart(Edelsteen.SAFFIEREN, 4, prijsVanKaart_81, 81));
	...
	niveau3.add(new Ontwikkelingskaart(Edelsteen.ONYXEN, 4, prijsVanKaart_82, 82));
	...
	niveau3.add(new Ontwikkelingskaart(Edelsteen.DIAMANTEN, 4, prijsVanKaart_83, 83));
	...
	niveau3.add(new Ontwikkelingskaart(Edelsteen.SMARAGDEN, 5, prijsVanKaart_84, 84));
	...
	niveau3.add(new Ontwikkelingskaart(Edelsteen.DIAMANTEN, 4, prijsVanKaart_85, 85));
	...
	niveau3.add(new Ontwikkelingskaart(Edelsteen.SAFFIEREN, 4, prijsVanKaart_86, 86));
	...
	niveau3.add(new Ontwikkelingskaart(Edelsteen.SMARAGDEN, 4, prijsVanKaart_87, 87));
	...
	niveau3.add(new Ontwikkelingskaart(Edelsteen.ONYXEN, 3, prijsVanKaart_88, 88));
	...
	niveau3.add(new Ontwikkelingskaart(Edelsteen.ROBIJNEN, 3, prijsVanKaart_89, 89));
	...
	niveau3.add(new Ontwikkelingskaart(Edelsteen.DIAMANTEN, 5, prijsVanKaart_90, 90));
